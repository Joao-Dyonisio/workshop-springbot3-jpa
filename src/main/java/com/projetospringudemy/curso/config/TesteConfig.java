...
public class TesteConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Pedido p2 = new Pedido(null, u2, Instant.parse("2019-07-21T03:42:10Z"), PedidoStatus.AGURADANDO_PAGAMENTO);
        Pedido p3 = new Pedido(null, u1, Instant.parse("2019-07-22T15:21:22Z"), PedidoStatus.ENTREGUE);
